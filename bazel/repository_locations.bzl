...
REPOSITORY_LOCATIONS_SPEC = dict(
    ...
    com_github_luajit_luajit = dict(
        ...
        version = "2.1.0",
        sha256 = "57AD1E3737C18A0BA7F447239449CAA9CF4901E8881479475445252148B8FE34",
        strip_prefix = "LuaJIT-{version}",
        urls = ["https://github.com/Boring545/LuaJIT/archive/{version}.tar.gz"],
        release_date = "2022-12-21",
        use_category = ["dataplane_ext"],
    ...
    io_bazel_rules_go = dict(
        ...
        project_url = "https://github.com/Boring545/rules_go",
        version = "0.38.1",
        sha256 = "2d4e643750db81f26fe89f25cfc4be55b750785be899a00c097e78fc1a15b575",
        urls = ["https://github.com/Boring545/rules_go/releases/download/v{version}/rules_go-v{version}.zip"],
    ...
    com_googlesource_googleurl = dict(
        ...
        urls = ["https://github.com/Boring545/envoybuild/releases/download/1.0/googleurl_{version}.tar.gz"],
        use_category = ["controlplane", "dataplane_core"],
        extensions = [],
    ...
    rules_rust = dict(
        ...
        project_url = "https://github.com/Boring545/rules_rust",
        version = "0.49.3",
        sha256 = "4a08dddd3b93056e2ceb9dc7bad985a7b30cb6c72bdf0f78201b890a7e8f440d",
        urls = ["https://github.com/Boring545/rules_rust/releases/download/{version}/rules_rust-v{version}.tar.gz"],
        use_category = ["dataplane_ext"],
        extensions = ["envoy.wasm.runtime.wasmtime"],
